...
if __name__ == '__main__':
    ...
    for repeat in range(repeats):
        ...
        data_dir = os.path.join(data_root, 'SCsDB/out')
        ...
        model.load_state_dict(torch.load("./model/general_model.pt"))
        

        for param in model.parameters():
            param.requires_grad = False

        for param in model.chem_ligandpocket.fc.predict.parameters():
            param.requires_grad = True

        for param in model.chem_pocketligand.fc.predict.parameters():
            param.requires_grad = True
